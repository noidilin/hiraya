                ...
                <Typography variant="body1" color="text.secondary" paragraph sx={{ lineHeight: 1.6 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 3, mb: 3 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="body2">Free shipping over $150</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Paper elevation={2}>
            ...
            <Box sx={{ px: 4 }}>
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph sx={{ lineHeight: 1.8 }}>
                  Discover the story, texture, and character of this curated vintage fashion piece.
                  Each Hiraya Vintage find is selected for distinctive era cues, wearable condition,
              ...
              <TabPanel value={tabValue} index={1}>
                <Grid container spacing={2}>
                  ...
                  <Grid size={{ xs: 12, sm: 6 }}>
                    ...
                    <Typography variant="body1" paragraph>Free over $150</Typography>
                  </Grid>
                </Grid>
              </TabPanel>
