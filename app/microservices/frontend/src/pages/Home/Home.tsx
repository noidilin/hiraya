...
const Home: React.FC = () => {
  ...
  return (
    <>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Fade in timeout={1000}>
                <Box>
                  ...
                  >
                    Explore curated vintage fashion pieces selected for character, craft, and everyday wearability.
                  </Typography>
      ...
      {/* Featured Vintage Finds Section */}
        ...
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: 6 }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ mb: 4 }}>
              Discover our handpicked selection of vintage fashion finds
            </Typography>
          </Box>
