...
const getImageForProduct = (product) => {
  ...
  if (productName.includes('prairie') || productName.includes('dress')) {
    return '/product-images/1970s-prairie-midi-dress.jpg';
  } else if (productName.includes('blazer') || productName.includes('wool')) {
    return '/product-images/1980s-wool-blazer.jpg';
  } else if (productName.includes('shoulder bag') || productName.includes('bag')) {
    return '/product-images/1990s-leather-shoulder-bag.jpg';
  } else if (productName.includes('art deco') || productName.includes('necklace')) {
    return '/product-images/art-deco-pendant-necklace.jpg';
  } else if (productName.includes('boots') || productName.includes('heel')) {
    return '/product-images/suede-block-heel-boots.jpg';
  }
...
app.listen(PORT, () => {
  ...
  console.log(`Connected to database: ${process.env.DB_NAME || 'products_db'}`);
