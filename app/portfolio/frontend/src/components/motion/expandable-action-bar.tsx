...
function useActionItemWidths(items: ExpandableActionBarItem[]) {
...
export function ExpandableActionBar({
  ...
  const { setMeasureRef, widths: labelWidths } = useActionItemWidths(items)
              ...
              >
                {isHighlighted ? (
                  <motion.span
                    ...
                    className="absolute inset-0 -z-10 rounded-[inherit] bg-primary/[0.07]"
                    transition={ITEM_TRANSITION}
                  />
                ) : null}
                ...
                {renderItem ? (
                  ...
                  <>
                    ...
                    <motion.span
                      ...
                      style={{ willChange: reduce ? undefined : "width, opacity, transform" }}
                    >
                      {item.label}
                    </motion.span>
