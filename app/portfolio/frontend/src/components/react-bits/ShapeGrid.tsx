...
export function ShapeGrid({
  ...
  useEffect(() => {
    ...
    const recordHoveredCell = (cell: GridOffset) => {
      if (
        !hoveredSquareRef.current ||
        hoveredSquareRef.current.x !== cell.x ||
        hoveredSquareRef.current.y !== cell.y
      ) {
