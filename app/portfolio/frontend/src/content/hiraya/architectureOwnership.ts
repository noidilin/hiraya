  ...
  boundaries: [
    ...
    },
    {
      ...
      layers: [
        {
          id: 'argocd-root-app',
          label: 'Argo CD root app',
          brief: 'Hands cluster ownership to GitOps.',
        },
        {
          id: 'platform-namespaces',
          label: 'Platform namespaces',
          brief: 'Create shared operational boundaries.',
        },
        {
          id: 'gateway-api-crds',
          label: 'Gateway API CRDs',
          brief: 'Define routing vocabulary.',
        },
        {
          id: 'aws-load-balancer-controller',
          label: 'AWS Load Balancer Controller',
          brief: 'Translates selected routes to AWS load balancing.',
        },
        {
          id: 'externaldns-external-secrets',
          label: 'ExternalDNS / External Secrets',
          brief: 'Bridge Kubernetes intent to AWS DNS and secrets.',
        },
        {
          id: 'kube-prometheus-stack',
          label: 'kube-prometheus-stack',
          brief: 'Installs shared monitoring capability.',
        },
      ],
    ...
    },
    {
      ...
      label: 'Public Edge',
      shortLabel: 'Edge',
      primaryOwner: 'Shared ingress policy and route manifests',
      supportingMechanisms: ['Route 53', 'ACM', 'ALB', 'Gateway API', 'HTTPRoute', 'ExternalDNS'],
      layers: [
        {
          id: 'public-dns-names',
          label: 'Public DNS names',
          brief: 'Define reachable hostnames.',
        },
        {
          id: 'acm-certificate',
        ...
        },
        {
          ...
          brief: 'Publishes selected Kubernetes routes.',
        },
        {
          id: 'storefront-api-route-policy',
          label: 'Storefront/API route policy',
          brief: 'Limits public exposure to intended entry points.',
        },
      ],
      responsibility: 'Control which parts of Hiraya become publicly reachable through one shared HTTPS boundary.',
      decision: 'Use shared ingress instead of exposing each service through independent public LoadBalancers.',
      doesNotOwn: ['private backend service logic', 'image publishing', 'secret source values', 'rollout approval'],
    },
    {
