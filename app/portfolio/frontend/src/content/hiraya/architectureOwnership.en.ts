...
export const architectureOwnershipContentEn = {
  ...
  chrome: {
    ...
    ownerLabel: 'Owner',
    selectedBoundaryLabel: 'selected boundary',
    primaryOwnerLabel: 'Primary owner',
    responsibilityLabel: 'responsibility',
    designDecisionLabel: 'design decision',
    ownedLayersLabel: 'Owned/control layers',
    supportingMechanismsLabel: 'Supporting mechanisms',
    doesNotOwnLabel: 'Does not own',
    boundaryStackAriaSuffix: 'boundary stack',
  },
  boundaries: [
    {
