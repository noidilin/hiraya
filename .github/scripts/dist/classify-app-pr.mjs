...
function assertSupportedGlobSyntax(pattern) {
    if (pattern.includes('[')) {
...
function selectChangedImageServices(files, catalog, options) {
...
async function writeGithubOutput(outputPath, classification, matrix) {
    if (!outputPath) {
        return;
    }
...
async function writeStepSummary(classification, matrix) {
