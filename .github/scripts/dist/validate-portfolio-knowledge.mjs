...
function parseFrontmatter(fileName, content, errors) {
...
function validateFrontmatter(fileName, expectedCategory, frontmatter, errors) {
    if (!frontmatter) {
        return;
    }
...
function validateMarkdown(fileName, body, content, errors) {
