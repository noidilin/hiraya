...
- You only need a normal platform deploy. Use [deploy-dev-platform.md](deploy-dev-platform.md).
- You are resolving an already-detected Helm release name conflict. Use [../troubleshooting/gateway-api-crd-helm-conflict.md](../troubleshooting/gateway-api-crd-helm-conflict.md).
- You are changing public ingress design rather than CRD ownership.
...
If Terraform reports a Helm release name conflict for `gateway-api-crds`, stop the cutover and use [../troubleshooting/gateway-api-crd-helm-conflict.md](../troubleshooting/gateway-api-crd-helm-conflict.md).
...
3. If the Helm release state move fails, use [../troubleshooting/gateway-api-crd-helm-conflict.md](../troubleshooting/gateway-api-crd-helm-conflict.md) or recreate the disposable platform stack.
